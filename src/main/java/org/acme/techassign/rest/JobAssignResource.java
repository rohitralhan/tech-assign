...
public class JobAssignResource {
    ...
    public TechJobAssign get() {
        ...
        //for(Job jc : jobCenter.getJobs())
        //System.out.println(jc.getTech()!= null);
        return jobCenter;
    }
    ...
    public void solve() {
    	...
    	solverService.startSolving(bestSolution.get(), bestSolutionChangedEvent -> {
            ...
            for(Tech t : bestSolutionChangedEvent.getNewBestSolution().getTechs()) {
            	System.out.println(t.getName() + " --> " + t.getAssignedCalls());
            }
            System.out.println("###################");
